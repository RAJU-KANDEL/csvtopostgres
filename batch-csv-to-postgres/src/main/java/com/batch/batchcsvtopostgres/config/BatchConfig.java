...
public class BatchConfig {
    ...
    public LineMapper<SalesRecord> getLineMapper() {
        ...
        lineTokenizer.setNames(new String[] { "Country", "Item Type", "Order ID",
    ...
    public JdbcBatchItemWriter<SalesRecord> writer() {
        ...
        writer.setItemSqlParameterSourceProvider(new BeanPropertyItemSqlParameterSourceProvider<SalesRecord>());
        writer.setSql("insert into sales_records(country, item_type, order_id, units_sold, unit_price, unit_cost)" +
